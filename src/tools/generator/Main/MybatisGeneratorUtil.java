...
import sqlgen.SqlCreaterWhereCondition;
...
public class MybatisGeneratorUtil {
	...
	public static void main(String[] args) throws Exception {
		...
		SqlCreaterWhereCondition sqlCreaterWhereCondition = new SqlCreaterWhereCondition();
		...
		projectPath = genConfigFile.getParentFile().getParentFile().getParentFile().getParentFile().getAbsolutePath().replaceAll("%20",
				" ");
...
//				System.out.println(" set createMode value is " + createMode);
		...
		replaceMap.put("whereCondition", sqlCreaterWhereCondition.create(conn, tableName));
